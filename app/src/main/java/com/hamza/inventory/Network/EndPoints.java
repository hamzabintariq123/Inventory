package com.hamza.inventory.Network;

/**
 * Created by Harry on 10/15/2016.
 */
public class EndPoints
{
    public static String BASE_URL="http://www.neelamlabs.com/";
    public static String LOGIN=BASE_URL+"Welcome/Login";
